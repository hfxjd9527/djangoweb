...
class BigCategory(models.Model):
    # 导航名称
    name = models.CharField(verbose_name='导航大分类', max_length=20)
    ...
    keywords = models.TextField(verbose_name='关键字', max_length=240,
...
# 文章关键词，用来做SEO中的keyword
class Keyword(models.Model):
    name = models.CharField(verbose_name='文章关键词', max_length=20)
...
class Carousel(models.Model):
    number = models.IntegerField(
        verbose_name='编号',
        help_text='编号决定图片播放的顺序，图片不要多于5张')
